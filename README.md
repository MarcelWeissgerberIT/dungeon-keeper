...
Neu: **Gefängnis, Folterkammer und Ritualkammer**. Besiegte Eindringlinge können gefangen, per Hand umgesetzt und von Runenwebern zu eigenen Wächtern bekehrt werden. Der Aschensegen verstärkt dein Reich zeitweise. Die Raumleiste enthält neun Räume und ist scrollbar. [Regeln und Bedienung](docs/DARK-ARTS.md).
